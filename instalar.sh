...
escribirConfig () {
	...
	echo "EJECUTABLESDIR=$GRUPO/$EJECUTABLES,$WHO,$WHEN" >> "$CONFG"
	echo "MAESTROSDIR=$GRUPO/$MAESTROS,$WHO,$WHEN" >> "$CONFG"
	echo "NOVEDADESDIR=$GRUPO/$NOVEDADES,$WHO,$WHEN" >> "$CONFG"
	echo "ACEPTADOSDIR=$GRUPO/$ACEPTADOS,$WHO,$WHEN" >> "$CONFG"
	echo "RECHAZADOSDIR=$GRUPO/$RECHAZADOS,$WHO,$WHEN" >> "$CONFG"
	echo "VALIDADOSDIR=$GRUPO/$VALIDADOS,$WHO,$WHEN" >> "$CONFG"
	echo "REPORTESDIR=$GRUPO/$REPORTES,$WHO,$WHEN" >> "$CONFG"
	echo "LOGDIR = $GRUPO/$LOG,$WHO,$WHEN" >> "$CONFG"
	echo "DIRPPAL=$GRUPO,$WHO,$WHEN" >> "$CONFG"
